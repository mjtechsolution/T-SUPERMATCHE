...
var searchFor = "Nom de la recherche/Mobile";

$(document).ready(function () {
  let init_customer_select2 =
    typeof load_customer_select2 === "function"
      ? load_customer_select2()
      : true;
  ...
  function formatRepo(repo) {
    ...
    return repo.mobile != "" && repo.mobile != null
      ? repo.text + " - " + repo.mobile
      : repo.text;
  }
