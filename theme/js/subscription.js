...
function update_status(id, status) {
  var base_url = $("#base_url").val();
  $.post(
    base_url + "subscription/update_status",
    { id: id, status: status },
    function (result) {
      if (result == "success") {
...
function delete_subscription(q_id) {
  ...
  if (confirm("Do You Wants to Delete Record ?")) {
    ...
    $.post(
      base_url + "subscription/delete_subscription",
      { q_id: q_id },
      function (result) {
        //alert(result);return;
        if (result == "success") {
...
function pay_now(subscription_id) {
  $.post(
    $("#base_url").val() + "subscription/show_pay_now_modal",
...
function save_payment(subscription_id) {
  ...
  $.post(
    base_url + "subscription/save_payment",
    {
...
function pay_return_due(subscription_id) {
  $.post(
    $("#base_url").val() + "subscription/show_pay_return_due_modal",
    { subscription_id: subscription_id },
    function (result) {
...
function save_return_due_payment(subscription_id) {
  ...
  $(".payment_save").attr("disabled", true); //Enable Save or Update button
  $.post(
    base_url + "subscription/save_return_due_payment",
    {
      account_id: account_id,
      subscription_id: subscription_id,
      payment_type: payment_type,
...
function delete_opening_balance_entry(entry_id) {
  if (confirm("Do You Wants to Delete Record ?")) {
    ...
    $.post(
      base_url + "subscription/delete_opening_balance_entry",
      { entry_id: entry_id, subscription_id: $("#q_id").val() },
      function (result) {
        //alert(result);//return;
        result = result;
        if (result == "success") {
