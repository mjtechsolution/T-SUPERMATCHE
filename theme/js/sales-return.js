...
$("#save,#update,#create").on("click", function (e) {
  ...
  $.ajax({
    ...
    url:
      base_url +
      "sales_return/sales_save_and_update?command=" +
      this_id +
      "&rowcount=" +
      rowcount +
      "&tot_subtotal_amt=" +
...
function return_row_with_data(item_id) {
  ...
  var rowcount = $("#hidden_rowcount").val();
  $.post(
    base_url + "sales_return/return_row_with_data/" + rowcount + "/" + item_id,
    { sales_id: sales_id },
    function (result) {
      //alert(result);
...
function delete_payment(payment_id) {
  if (confirm("Do You Wants to Delete Record ?")) {
    ...
    $.post(
      base_url + "sales_return/delete_payment",
...
function delete_return(q_id) {
  ...
  if (confirm("Do You Wants to Delete Record ?")) {
    ...
    $.post(
      base_url + "sales_return/delete_return",
      { q_id: q_id },
      function (result) {
        //alert(result);return;
        if (result == "success") {
...
function pay_now(return_id) {
  var base_url = $("#base_url").val();
  $.post(
    base_url + "sales_return/show_pay_now_modal",
    { return_id: return_id },
    function (result) {
...
function view_payments(return_id) {
  var base_url = $("#base_url").val();
  $.post(
    base_url + "sales_return/view_payments_modal",
    { return_id: return_id },
    function (result) {
...
function save_payment(return_id) {
  ...
  $.post(
    base_url + "sales_return/save_payment",
    {
