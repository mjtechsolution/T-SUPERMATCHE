...
function update_status(id, status) {
  var base_url = $("#base_url").val();
  $.post(
    base_url + "package/update_status",
    { id: id, status: status },
    function (result) {
      if (result == "success") {
...
function delete_package(q_id) {
  ...
  if (confirm("Do You Wants to Delete Record ?")) {
    ...
    $.post(
      base_url + "package/delete_package",
      { q_id: q_id },
      function (result) {
        //alert(result);return;
        if (result == "success") {
...
function pay_now(package_id) {
  $.post(
    $("#base_url").val() + "package/show_pay_now_modal",
...
function pay_return_due(package_id) {
  $.post(
    $("#base_url").val() + "package/show_pay_return_due_modal",
    { package_id: package_id },
    function (result) {
...
function save_return_due_payment(package_id) {
  ...
  $(".payment_save").attr("disabled", true); //Enable Save or Update button
  $.post(
    base_url + "package/save_return_due_payment",
    {
      account_id: account_id,
      package_id: package_id,
      payment_type: payment_type,
...
function delete_opening_balance_entry(entry_id) {
  if (confirm("Do You Wants to Delete Record ?")) {
    ...
    $.post(
      base_url + "package/delete_opening_balance_entry",
      { entry_id: entry_id, package_id: $("#q_id").val() },
      function (result) {
        //alert(result);//return;
        result = result;
        if (result == "success") {
