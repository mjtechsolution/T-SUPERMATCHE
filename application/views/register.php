      ...
      ?>
        ...
        <div class="div1">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="first_name" class="input-text" placeholder="<?= $this->lang->line('first_name') ?>*" autofocus="">
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
            <small class="pull-left text-danger form-text hide first_name_msg"></small>
          </div>
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="last_name" class="input-text" placeholder="<?= $this->lang->line('last_name') ?>*">
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          ...
          <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="<?= $this->lang->line('password') ?>" id="password" name="password">
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            <small class="pull-left text-danger form-text hide password_msg"></small>
          </div>
          <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="<?= $this->lang->line('confirm_password') ?>" id="cpassword" name="cpassword">
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        ...
        <div class="div2 hide">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="store_name" class="input-text" placeholder="<?= $this->lang->line('store_name') ?>*">
          ...
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="city" class="input-text" placeholder="<?= $this->lang->line('city') ?>*">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            <p style='font-style: italic;'>Version 2023_V1</p>
          </div>
        </div>
        </div>
        <!-- /.login-box-body -->
        ...
        if (typeof data == 'object') {
          for (var value of data.values()) {
            if (typeof value != 'object' && (value != '' && value.indexOf("<script>") != -1)) {
              toastr["error"]("Impossible de continuer! Code XSS trouvé en entrée!");
              return false;
            }
          }
          return true;
