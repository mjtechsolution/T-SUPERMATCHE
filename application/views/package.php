...
<body class="hold-transition skin-blue sidebar-mini">
   <div class="wrapper">
      ...
      <div class="content-wrapper">
         ...
         <section class="content-header">
            <h1>
               <?= $page_title; ?>
               <small><?= $this->lang->line('add/edit') ?> Colis</small>
            </h1>
            <ol class="breadcrumb">
                     ...
                     <div class="box-body">
                        ...
                        <div class="row">
                           <div class="col-md-5">
                              ...
                              <div class="form-group parent_4">
                                 <label for="plan_type" class="col-sm-4 control-label"><?= $this->lang->line('plan_type'); ?><label class="text-danger">*</label></label>
                                 <div class="col-sm-8">
                              ...
                              <div class="form-group parent_1">
                                 <label for="monthly_price" class="col-sm-4 control-label"><?= $this->lang->line('monthly_price'); ?><label class="text-danger">*</label></label>
                                 <div class="col-sm-8">
                                    <input type="text" class="form-control only_currency text-right" id="monthly_price" name="monthly_price" placeholder="" value="<?php print $monthly_price; ?>">
                              ...
                              <div class="form-group parent_2">
                                 <label for="annual_price" class="col-sm-4 control-label"><?= $this->lang->line('annual_price'); ?><label class="text-danger">*</label></label>
                                 <div class="col-sm-8">
                                    <input type="text" class="form-control only_currency text-right" id="annual_price" name="annual_price" placeholder="" value="<?php print $annual_price; ?>">
                                    <span class='text-warning pull-right'>Note: Minimum '0'</span>
                                    <span id="annual_price_msg" style="display:none" class="text-danger"></span>
                                 </div>
                              </div>
                              <div class="form-group parent_3 ">
   ...
   <script type="text/javascript">
      ...
      function _change_on_package_type() {
         var package_type = $("#package_type").val();

         if (package_type == 'Free') {

            //HIDE: monthly & annual price
            $("#monthly_price").val(0);
            $(".parent_1").hide();
      ...
      function show_plan_wise() {

         var plan_type = $("#plan_type").val();

         if (plan_type == 'Monthly') {
            $(".parent_1").show(); //monthly input

            $(".parent_2").hide(); //Yearly input
            $("#monthly_price").val(0);
            $("#annual_price").val(0);
         } else {
            $(".parent_1").hide(); //monthly input
            $("#annual_price").val(0);
            $("#monthly_price").val(0);

            $(".parent_2").show(); //Yearly input
         }
