...
<body class="hold-transition skin-blue sidebar-mini">
   <div class="wrapper">
      ...
      <div class="content-wrapper">
         ...
         <section class="content-header">
            <h1>
               <?= $page_title; ?>
               <small><?= $this->lang->line('add/edit') ?> Transfert de stock</small>
            </h1>
            <ol class="breadcrumb">
                           ...
                           <div class="col-sm-12">
                              ...
                              <div class="col-md-8 col-md-offset-2 d-flex justify-content">
                                 <div class="input-group">
                                    ...
                                    <input type="text" class="form-control " placeholder="<?= $this->lang->line('Item name/Barcode/Itemcode') ?>" id="item_search">
                     ...
                     <div class="box-footer col-sm-12">
                        <center>
                           ...
                           <div class="col-md-3 col-md-offset-3">
                              <button type="button" id="<?php echo $btn_id; ?>" class="btn bg-maroon btn-block btn-flat btn-lg payments_modal" title="Save Data"><?= $this->lang->line('save') ?></button>
                           </div>
                           <div class="col-sm-3"><a href="<?= base_url() ?>dashboard">
                                 <button type="button" class="btn bg-gray btn-block btn-flat btn-lg" title="Go Dashboard"><?= $this->lang->line('close') ?></button>
                              </a>
                           </div>
                        </center>
                     </div>
   ...
   <script>
      ...
      $("#store_from").on("change", function() {
         ...
         $.post(base_url + "sales/get_warehouse_select_list", {
            store_id: store_id
         }, function(result) {
            result = '<option value="">-Tous-</option>' + result;
