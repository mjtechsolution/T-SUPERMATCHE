              ...
              <form class="form-horizontal" id="import-form" enctype="multipart/form-data" method="POST">
                ...
                <div class="box-footer">
                  <div class="col-sm-8 text-center">
                    <div class="col-md-3 ">
                      <button type="button" id="import" class=" btn btn-block btn-success" title="Save Data"><i class="fa fa-arrow-circle-o-left "></i>
                        <?= $this->lang->line('import'); ?>
                      </button>
                    </div>
                    <div class="col-sm-3">
                      <a href="<?= base_url('dashboard'); ?>">
                        <button type="button" class="col-sm-3 btn btn-block btn-warning close_btn" title="Go Dashboard">
