...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          <?= $page_title; ?>
          <small><?= $this->lang->line('add/edit') ?> Marque</small>
        </h1>
        <ol class="breadcrumb">
              ...
              <div class="box-body table-responsive no-padding">
                ...
                <table class="table table-bordered table-hover " id="report-data">
                  ...
                  <tbody id="tbodyid">
                    ...
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $this->lang->line('auteur'); ?></td>
                      <td style="color:green;"><span class="label label-success"><?= $this->lang->line('required'); ?></span></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $this->lang->line('verificateur'); ?></td>
                      <td style="color:green;"><span class="label label-default"><?= $this->lang->line('optional'); ?></span></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $this->lang->line('traducteur'); ?></td>
                      <td style="color:green;"><span class="label label-success"><?= $this->lang->line('required'); ?></span></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $this->lang->line('annee'); ?></td>
                      <td style="color:green;"><span class="label label-success"><?= $this->lang->line('required'); ?></span></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $this->lang->line('ISBN'); ?></td>
                      <td style="color:green;"><span class="label label-default"><?= $this->lang->line('optional'); ?></span></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $this->lang->line('nedition'); ?></td>
                      <td style="color:green;"><span class="label label-default"><?= $this->lang->line('optional'); ?></span></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $this->lang->line('theme'); ?></td>
                      <td style="color:green;"><span class="label label-success"><?= $this->lang->line('required'); ?></span></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $this->lang->line('naturedepapier'); ?></td>
                      <td style="color:green;"><span class="label label-default"><?= $this->lang->line('optional'); ?></span></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $this->lang->line('Couverture'); ?></td>
                      <td style="color:green;"><span class="label label-default"><?= $this->lang->line('optional'); ?></span></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $this->lang->line('emplacement'); ?></td>
                      <td style="color:green;"><span class="label label-default"><?= $this->lang->line('optional'); ?></span></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $this->lang->line('collection'); ?></td>
                      <td style="color:green;"><span class="label label-default"><?= $this->lang->line('optional'); ?></span></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $this->lang->line('bl'); ?></td>
                      <td style="color:green;"><span class="label label-default"><?= $this->lang->line('optional'); ?></span></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $this->lang->line('fa'); ?></td>
                      <td style="color:green;"><span class="label label-default"><?= $this->lang->line('optional'); ?></span></td>
                      <td></td>
                    </tr>
                    <tr>
  ...
  <script type="text/javascript">
    ...
    $("#import").on("click", function(e) {
      ...
      if ($("#import_file").val() == '') {
        toastr["warning"]("Veuillez sélectionner le fichier à importer!");
        ...
        $.ajax({
          ...
          success: function(result) {
            if (result == "success") {
              ...
              toastr["error"]("Pardon! Impossible d’enregistrer Record.Essayez à nouveau!");
            } else {
              toastr["error"](result);
            }
