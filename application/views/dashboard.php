        ...
        <div class="row">
          <div class="box-header">
              <div class="btn-group pull-right">
                <button type="button" title="Today" class="btn btn-default btn-info get_tab_records active">
          ...
          <div class="box box-primary" >
            ...
            <div class="box-header ">
              ...
              <div class="btn-group pull-right hide">
                ...
                <button type="button" title="All Years" class="btn btn-default btn-info get_storewise_details active">-Tous-</button>
              </div>
            </div>
