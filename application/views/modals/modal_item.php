    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <!--                            <div class="box-body">-->
          <!--                              <div class="form-group">-->
          <!--                                <label for="auteur">--><?php //= $this->lang->line('auteur'); 
                                                                      ?><!--</label>-->
          <!--                                <span id="auteur" class="text-danger text-right pull-right"></span>-->
          <!--                                <input type="text" class="form-control maxlength  " id="auteur" name="auteur" placeholder=""  >-->
          <!--                              </div>-->
          <!--                            </div>-->
          <!--                          </div>-->
