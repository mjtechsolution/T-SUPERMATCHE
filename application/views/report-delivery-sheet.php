 ...
 <body class="hold-transition skin-blue sidebar-mini">
                         ...
                         <div class="box-footer">
                            <div class="col-sm-8 col-sm-offset-2 text-center">
                               <div class="col-md-3 col-md-offset-3">
                                  <button type="button" id="view" class=" btn btn-block btn-success" title="Save Data">Afficher</button>
                               </div>
                               <div class="col-sm-3">
    ...
    <script type="text/javascript">
       $("#view").on("click", function() {
          ...
          if (from_date == "") {
             toastr["warning"]("Sélectionnez la date!");
             document.getElementById("from_date").focus();
             return;
          }

          if (to_date == "") {
             toastr["warning"]("Sélectionner à ce jour!");
          ...
          $.post($("#base_url").val() + "reports/show_delivery_sheet", {
