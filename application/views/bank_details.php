...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small><?= $this->lang->line('View_Search')?> Colis</small>
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="box box-primary">
            ...
            <div class="box-footer">
                <div class="col-sm-12 text-left">                                 
                      <a href="<?=base_url('dashboard');?>" title="Go Dashboard" class="col-sm-3 btn btn-default close_btn pull-right"><?= $this->lang->line('close')?></a>
