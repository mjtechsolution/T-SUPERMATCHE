   ...
   <div class="wrapper">
      ...
      <div class="content-wrapper">
         ...
         <section class="content-header">
            <h1>
               <?= $page_title; ?>
               <small><?= $this->lang->line('add/edit') ?> Articles</small>
            </h1>
            <ol class="breadcrumb">
                  ...
                  <div class="box box-primary ">
                     ...
                     <div class="box-body">
                        ...
                        <div class="row">
                           ...
                           <!--                              <div class="form-group col-md-4">-->
                           <!--                                 <label for="sku">--><?php //= $this->lang->line('sku'); 
                                                                                    ?><!--</label>-->
                           ...
                           <!--                              </div>-->
                           <!--                              <div class="form-group col-md-4">-->
                           <!--                                 <label for="hsn">--><?php //= $this->lang->line('hsn'); 
                                                                                    ?><!--</label>-->
                           ...
                           <!--                                   <label for="ISBN" >--><?php //= $this->lang->line('ISBN'); 
                                                                                          ?><!--</label>-->
                           <!--                                   <input type="text" class="form-control " id="ISBN" name="ISBN" placeholder="ISBN"  value="--><?php //print $ISBN; 
                                                                                                                                                               ?><!--" >-->
                           ...
                           <div class="form-group col-md-4">
                              ...
                              <input type="text" class="form-control " id="emplacement" name="emplacement" placeholder="<?= $this->lang->line('emplacement'); ?>" value="<?php print $emplacement; ?>">
                              <span id="emplacement" style="display:none" class="text-danger"></span>
                           </div>

                           <div class="form-group col-md-4">
                              <label for="collection"><?= $this->lang->line('collection'); ?></label>
                              <input type="text" class="form-control " id="collection" name="collection" placeholder="<?= $this->lang->line('collection'); ?>" value="<?php print $collection; ?>">
                           ...
                           <div class="form-group col-md-4">
                              <label for="FA"><?= $this->lang->line('fa'); ?> </label>
                              <input type="text" class="form-control " id="FA" name="FA" placeholder="FA" value="<?php print $FA; ?>">
                              <span id="FA" style="display:none" class="text-danger"></span>
                           </div>
                        ...
                        <div class="row">
                           <div class="form-group col-md-4 ">
                              ...
                              <input type="text" class="form-control only_currency" id="price" name="price" placeholder="Prix de l’article sans taxe" value="<?php print $price; ?>">
                           ...
                           <div class="form-group col-md-4">
                              ...
                              <input type="text" class="form-control only_currency" id="purchase_price" name="purchase_price" placeholder="Prix total avec montant de la taxe" value="<?php print $purchase_price; ?>" readonly=''>
                           ...
                           <div class="form-group col-md-4">
                              ...
                              <input type="text" class="form-control only_currency" id="profit_margin" name="profit_margin" placeholder="Bénéfice en %" value="<?php print $profit_margin; ?>">
                           ...
                           <div class="form-group col-md-4">
                              ...
                              <input type="text" class="form-control only_currency " id="sales_price" name="sales_price" placeholder="Prix de vente" value="<?php print $sales_price; ?>">
                           ...
                           <div class="form-group col-md-4">
                              ...
                              <input type="text" class="form-control only_currency" id="mrp" name="mrp" placeholder="Prix de détail maximum" value="<?php print $mrp; ?>">
                                    ...
                                    <div class="box-header">
                                       <div class="col-md-6 col-md-offset-3 d-flex justify-content">
                                          <div class="input-group">
                                             ...
                                             <input type="text" class="form-control " placeholder="Variante de recherche" id="variant_search">
