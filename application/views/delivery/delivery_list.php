...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          <?= $page_title; ?>
          <small><?= $this->lang->line('View_Search') ?> Articles vendus</small>
        </h1>
        <ol class="breadcrumb">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="col-md-2 pull-right">
                      <?php if ($CI->permissions('delivery_add')) { ?>
                        <div class="box-tools">
                          <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>delivery/add">
                            <i class="fa fa-plus"></i> <?= $this->lang->line('create_delivery'); ?></a>
                        </div>
                      <?php } ?>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="delivery_from_date"><?= $this->lang->line('from_date'); ?> </label></label>
                        <div class="input-group date">
                          <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                          </div>
                          <input type="text" class="form-control pull-right datepicker" id="delivery_from_date" name="delivery_from_date">
                        </div>
                        <span id="delivery_from_date_msg" style="display:none" class="text-danger"></span>
                      </div>
                    </div>

                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="delivery_to_date"><?= $this->lang->line('to_date'); ?> </label></label>
                        <div class="input-group date">
                          <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                          </div>
                          <input type="text" class="form-control pull-right datepicker" id="delivery_to_date" name="delivery_to_date">
                        </div>
                        <span id="delivery_to_date_msg" style="display:none" class="text-danger"></span>
                      </div>
                    </div>
  ...
  <script type="text/javascript">
    ...
    $("#warehouse_id,#delivery_from_date,#delivery_to_date,#users").on("change", function() {
  ...
  <script type="text/javascript">
    ...
    function show_receipt(id) {
      window.open("<?= base_url(); ?>delivery/print_show_receipt/" + id, "_blank", "scrollbars=1,resizable=1,height=500,width=500");
    }
  </script>
