            ...
            <tr>
                ...
                <td width="35%">
                    <div class="facture_details">
                        ...
                        <hr>
                        <p class="dates text-center">
                            Date d'émisson : <?= $delivery_date ?>               
                        </p>
    ...
    <div class="page-break">
        ...
        <table width="100%" border="1">
            ...
            foreach ($q2->result() as $res2) {
                ...
                echo "<td class='text-left f-12' style='padding-bottom:10px'>" . store_number_format($res2->delivery_qty)   . "</td>";
        ...
        <table width=100% class="sign">
            <tr>
                <td style="padding:0;font-size:18px" width="50%"  class=" text-center py">
                ...
                <td style="padding:0;font-size:18px" width="50%" class="  text-center  b-l">    
