...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo $base_url; ?>delivery/add"><?= $this->lang->line('new_delivery'); ?></a></li>
      ...
      $q3 = $this->db->query("SELECT b.expire_date, b.sales_status, b.store_id,a.customer_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,
                           ...
                           b.`id`='$delivery_id' AND b.store_id=" . get_current_store_id());
      ...
      <section class="invoice">
        ...
        <div class="printableArea">
          <div class="row">
            <div class="col-xs-12">
              <h2 class="page-header">
                <i class="fa fa-globe"></i> Bon de livraison
          ...
          <div class="row invoice-info">
            ...
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
              <b>Livairison code #<?php echo  $delivery_code; ?></b><br>

              <?php if ($sales_status == 'Converted') { ?>
                <b><?= $this->lang->line('sales_invoice'); ?> #<a title="View to Invoice" href="<?= base_url() ?>sales/invoice/<?= get_sales_id_of_delivery($delivery_id) ?>"><?= get_sales_code(get_sales_id_of_delivery($delivery_id)); ?></a></b><br>
              <?php } ?>
            ...
            <div class="col-xs-12 table-responsive">
              <table class="table  records_table table-bordered">
                ...
                <tbody>
                  ...
                  $q2 = $this->db->query("SELECT a.description,c.item_name, a.delivery_qty,a.tax_type,
                                  a.price_per_unit, b.tax,b.tax_name,a.tax_amt,
                                  a.discount_input,a.discount_amt, a.unit_total_cost,
                                  a.total_cost 
                                  FROM 
                                  db_deliveryitems AS a,db_tax AS b,db_items AS c 
                                  WHERE 
                  ...
                  foreach ($q2->result() as $res2) {
                    ...
                    echo "<td>" . format_qty($res2->delivery_qty) . "</td>";
          ...
          <!-- <div class="row"> -->
            <!-- <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="delivery_note" class="col-sm-4 control-label" style="font-size: 17px;"><?= $this->lang->line('note'); ?></label>
                    <div class="col-sm-8">
        ...
        <div class="row no-print">
          <div class="col-xs-6">
            <?php if ($CI->permissions('delivery_edit')) { ?>
              <?php $str2 = ($pos == 1) ? 'pos/edit/' : 'delivery/update/'; ?>
              <a href="<?php echo $base_url; ?><?= $str2; ?><?php echo  $delivery_id ?>" class="btn btn-success">
            ...
            <!-- <?php if ($CI->permissions('sales_add') && $sales_status == '') { ?>
              <a href="<?php echo $base_url; ?>sales/delivery/<?php echo  $delivery_id ?>" class="btn btn-danger">
                <i class="fa  fa-undo"></i> Convert to Invoice
              </a>
            <?php } else { ?>
              <a href="<?php echo $base_url; ?>sales/invoice/<?= get_sales_id_of_delivery($delivery_id) ?>" class="btn btn-danger">
          ...
          <div class="col-xs-6 text-right">
            <a href="<?php echo $base_url; ?>delivery/print_invoice/<?php echo  $delivery_id ?>" target="_blank" class="btn btn-warning">
              <i class="fa fa-print"></i>
              Print
            </a>

            <a href="<?php echo $base_url; ?>delivery/pdf/<?php echo  $delivery_id ?>" target="_blank" class="btn btn-primary">
  ...
  <script>
    $(".delivery_list-active-li").addClass("active");
  </script>
</body>
