...
<body class="hold-transition skin-blue sidebar-mini">
   <div class="wrapper">
      ...
      <div class="content-wrapper">
         ...
         <section class="content-header">
            <h1>
               <?= $page_title; ?>
               <small><?= $this->lang->line('Enter_User_Information') ?></small>
            </h1>
            <ol class="breadcrumb">
                              ...
                              <div class="tab-pane active" id="tab_1">
                                 ...
                                 <div class="box-body">
                                    ...
                                    <div class="form-group"> -->
                                             ...
                                             <div class="col-sm-4">
                                                <input type="text" class="form-control no_special_char_no_space" id="mobile" name="mobile" placeholder="+212600000000" value="<?php print $mobile; ?>">
                                 ...
                                 <div class="col-md-5"> -->
                                    ...
                                    <div class="form-group"> -->
                                          ...
                                          <div class="form-group">
                                             ...
                                             <!-- </div>
                                    <div class="form-group"> -->
                                             <!--                                       <label for="state" class="col-sm-2 control-label">--><?php //= $this->lang->line('state'); 
                                                                                                                                             ?><!--</label>-->
                                             <!--                                       <div class="col-sm-4">-->
                                             <!--                                          <select class="form-control select2" id="state" name="state"  style="width: 100%;" >-->
                                             <!--                                          --><?php //= get_state_select_list($state_id); 
                                                                                                ?>
                                             <!--                                         </select>-->
                                    ...
                                    <div class="form-group"> -->
                                          ...
                                          <div class="form-group">
                                             ...
                                             <!-- </div>
                                    <div class="form-group"> -->
                                             <!--                                       <label for="shipping_state" class="col-sm-2 control-label">--><?php //= $this->lang->line('state'); 
                                                                                                                                                      ?><!--</label>-->
                                             <!--                                       <div class="col-sm-4">-->
                                             <!--                                          <select class="form-control select2" id="shipping_state" name="shipping_state"  style="width: 100%;" >-->
                                             <!--                                          --><?php //= get_state_select_list($shipping_state); 
                                                                                                ?>
                                             <!--                                         </select>-->
   ...
   <script type="text/javascript">
      function show_attachment(imagepath = '') {
         if (imagepath == '') {
            toastr["warning"]("Aucune pièce jointe disponible!");
