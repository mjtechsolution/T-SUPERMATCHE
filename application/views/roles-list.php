  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          <?= $page_title; ?>
          <small><?= $this->lang->line('View_Search') ?> Catégorie d’articles</small>
        </h1>
        <ol class="breadcrumb">
              ...
              <div class="box-header with-border">
                ...
                <div class="row">
                  ...
                  <?php if (store_module() && is_admin()) {
                    $this->load->view('store/store_code', array('show_store_select_box_1' => true, 'store_id' => get_current_store_id()));
                  } else {
