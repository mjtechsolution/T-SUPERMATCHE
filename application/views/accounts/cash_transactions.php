...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <script type="text/javascript">
    ...
    function link_account(account_of, rec_id, prev_acc_id = '') {
      if (account_of == 0) {
        toastr["warning"]("Impossible de créer un lien");
        return;
      }
    ...
    function update_account_link() {
      ...
      if (account_of == 0 || account_id == '' || rec_id == '') {
        toastr["error"]("ID de compte ou ID d’enregistrement manqué !!");
        return;
      }

      if (prev_acc_id == account_id) {
        toastr["error"]("Ce compte déjà attribué !!");
        return;
      }

      $(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
      $(".payment_save").attr('disabled', true); //Enable Save or Update button
      $.post(base_url + 'cash_transactions/link_account', {
        ...
        if (result == "success") {
          ...
          toastr["error"]("Pardon! Impossible de mettre à jour Record.Essayez à nouveau!");
