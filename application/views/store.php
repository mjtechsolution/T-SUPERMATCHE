   ...
   <div class="wrapper">
      ...
      if (!isset($q_id)) {
         ...
         $mobile = $phone = $email = $country = $state = $city =
            $postcode = $address = $gst_no = $vat_no = $cnss = $rc =
                                    ...
                                    <div class="row">
                                       <div class="col-md-5">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-sm-8">
                                                <input type="text" class="form-control no_special_char_no_space" id="phone" name="phone" placeholder="" value="<?php print $phone; ?>" onkeyup="shift_cursor(event,'cnss')">
                                                <span id="phone_msg" style="display:none" class="text-danger"></span>
                                             </div>
                                          </div>

                                          <div class="form-group">
                                             <label for="cnss" class="col-sm-4 control-label"><?= $this->lang->line('cnss'); ?></label>
                                             <div class="col-sm-8">
                                                <input type="text" class="form-control no_special_char_no_space" id="cnss" name="cnss" placeholder="" value="<?php print $cnss; ?>" onkeyup="shift_cursor(event,'rc')">
                                                <span id="cnss_msg" style="display:none" class="text-danger"></span>
                                             </div>
                                          </div>

                                          <div class="form-group">
                                             <label for="rc" class="col-sm-4 control-label"><?= $this->lang->line('rc'); ?></label>
                                             <div class="col-sm-8">
                                                <input type="text" class="form-control no_special_char_no_space" id="rc" name="rc" placeholder="" value="<?php print $rc; ?>" onkeyup="shift_cursor(event,'gst_no')">
                                                <span id="rc_msg" style="display:none" class="text-danger"></span>
                                             </div>
                                          </div>
                        ...
                        <center>
                           ...
                           <div class="col-sm-3">
                              <a href="<?= base_url('dashboard'); ?>">
                                 <button type="button" class="col-sm-3 btn btn-block btn-warning close_btn" title="Go Dashboard">Ferme</button>
                              </a>
                           </div>
                        </center>
                     </div>
