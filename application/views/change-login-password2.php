                    ...
                    <div class="login-section">
                        ...
                        <div class="form-container">
                            ...
                            <div class="form-group form-fg">
                                <input type="password" name="password" class="input-text" placeholder="Nouveau mot de passe">
                                <i class="fa fa-lock"></i>
                            </div>
                            <div class="form-group form-fg">
                                <input type="password" name="cpassword" class="input-text" placeholder="Confirmer le mot de passe">
                                <i class="fa fa-lock"></i>
                            </div>
                            <div class="checkbox clearfix">
                                <a href="<?= base_url('login/forgot_password') ?>">Mot de passe oublié</a>
                            </div>
