                  ...
                  <div class="box">
                     <div class="box-header">
                        ...
                        <?php if (warehouse_module() && warehouse_count() > 1) {
                           $this->load->view('warehouse/warehouse_code', array('show_warehouse_select_box_1' => true, 'div_length' => 'col-md-3', 'label_length' => 'col-md-3', 'show_all' => 'true', 'show_all_option' => true));
                        } else {
