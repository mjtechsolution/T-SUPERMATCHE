...
<body class="hold-transition skin-blue layout-top-nav">
              ...
              <form class="form-horizontal" id="pos-form">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-warning" data-dismiss="modal"><?= $this->lang->line('close') ?></button>
                ...
                <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <input type="text" class="form-control" data-toggle="tooltip" title="Invoice Count ID" placeholder="Numéro d’invioce" id="count_id" name="count_id" value="<?= $count_id ?>">
                    </div>
                ...
                <div class="box-footer bg-gray">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 text-right">
                      ...
                      <div class="col-sm-3">
                        <button type="button" id="pay_all" name="" class="btn bg-purple btnhold btn-block btn-flat btn-lg Alt_a" title="Payer tout" style="">
                          <i class="fa fa-money" aria-hidden="true"></i>
                          Payer tout
                        </button>
                      </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="input-group input-group-md">
                      ...
                      <input type="text" class="form-control" data-toggle="tooltip" title="Enter Item Name" placeholder="<?= $this->lang->line('Item_Name') ?>" id="item_name" name="item_name">
  ...
  <script>
    ...
    function item_qty_input(item_id, rowcount) {
      ...
      if (service_bit != 1) {
        if (stock == 0) {
          toastr["warning"]("Article non disponible en stock!");
          //return;  
        }
        if (parseFloat(item_qty) > parseFloat(stock)) {
          $("#item_qty_" + item_id).val(format_qty(stock));
          toastr["warning"]("Oups! Vous n’avez que " + stock + " articles en stock");
          // return;
        }
        if (item_qty == 0) {
          $("#item_qty_" + item_id).val(format_qty(1));
          toastr["warning"]("Vous devez avoir au moins une quantité");
          //return; 
        }
        /*else{
