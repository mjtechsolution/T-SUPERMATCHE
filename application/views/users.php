...
<body class="hold-transition skin-blue sidebar-mini">
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 ...
                                 <?php if (store_module() && is_admin()) {
                                    $this->load->view('store/store_code', array('show_store_select_box' => true, 'store_id' => $store_id, 'label_length' => 'col-sm-4', 'div_length' => 'col-sm-8'));
                                 } else {
   ...
   <script type="text/javascript">
      ...
      function load_roles() {
         ...
         $.post(base_url + "users/get_roles_select_list", {
            store_id: store_id
         }, function(result) {
