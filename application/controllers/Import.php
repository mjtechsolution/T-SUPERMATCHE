                ...
                {   
                    ...
                    while(($importdata = fgetcsv($file, NULL, ",")) !== FALSE){
                        ...
                        $row = array(
                            ...
                            'editeur'           => !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[20]):0,
                            'verificateur'      => !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[21]):0,
                            'traducteur'        => !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[22]):0,
                            'auteur'            => !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[23]):0,
                            'couverture'        => !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[24]):0,
                            'nature_de_Papier'  => !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[25]):0,
                            'n_edition'         => !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[26]):0,
                            'ISBN'              => !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[27]):0,
                            'annee_edition'     => !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[28]):0,
                            'emplacement'       => !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[29]):0,
                            'collection'        => !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[30]):0,
                            'BL'                => !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[31]):0,
                            'FA'                => !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[32]):0,
                            'theme'             => !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[33]):0,
                            'item_image'        => !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[34]):0,
