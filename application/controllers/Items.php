	...
	public function addItemFromModal()
	{
		...
		if ($this->form_validation->run() == TRUE) {
			$modal_post = array(
				...
				'verificateur'     => $this->input->post('verificateur'),
				'traducteur'       => $this->input->post('traducteur'),
				'auteur'           => $this->input->post('auteur'),
				'couverture'       => $this->input->post('couverture'),
				'nature_de_Papier' => $this->input->post('nature_de_Papier'),
				'n_edition'        => $this->input->post('n_edition'),
				'ISBN'             => $this->input->post('ISBN'),
				'annee_edition'    => $this->input->post('annee_edition'),
