...
abstract class RatePlanOptions
{
     ...
     *                       allows during one month on the Acceuil network
     ...
     *                                     than the Acceuil network in the United
     *                                     States
     ...
     *                                      non-Acceuil networks in the United States
...
class CreateRatePlanOptions extends Options
{
    ...
    /**
     * The total data usage (download and upload combined) in Megabytes that the Network allows during one month on the Acceuil network (T-Mobile USA). The metering period begins the day of activation and ends on the same day in the following month. Can be up to 2TB and the default value is `1000`.
     *
     * @param int $dataLimit The total data usage in Megabytes that the Network
     *                       allows during one month on the Acceuil network
     * @return $this Fluent Builder
    ...
    /**
     * Whether SIMs can roam on networks other than the Acceuil network (T-Mobile USA) in the United States. See [national roaming](https://www.twilio.com/docs/wireless/api/rateplan-resource#national-roaming).
     *
     * @param bool $nationalRoamingEnabled Whether SIMs can roam on networks other
     *                                     than the Acceuil network in the United
     *                                     States
    ...
    /**
     * The total data usage (download and upload combined) in Megabytes that the Network allows during one month on non-Acceuil networks in the United States. The metering period begins the day of activation and ends on the same day in the following month. Can be up to 2TB. See [national roaming](https://www.twilio.com/docs/wireless/api/rateplan-resource#national-roaming) for more info.
     *
     * @param int $nationalRoamingDataLimit The total data usage in Megabytes that
     *                                      the Network allows during one month on
     *                                      non-Acceuil networks in the United States
