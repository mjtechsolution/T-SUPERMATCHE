...
class CreatePaymentOptions extends Options
{
    ...
    /**
     * The currency of the `charge_amount`, formatted as [ISO 4127](http://www.iso.org/iso/Acceuil/standards/currency_codes.htm) format. The default value is `USD` and all values allowed from the <Pay> Connector are accepted.
     *
     * @param string $currency The currency of the `charge_amount`.
     * @return $this Fluent Builder
     */
